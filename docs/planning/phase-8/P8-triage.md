...
- **Accept (fix in Phase 8):** 6 findings → 017, 018, 019, 021, 022, 023
- **Investigate (decision needed):** 1 finding → 024
...
exists *because* of #102 — adding nested-parent-ID parameters to command and
...
2. **For finding 3c (`OgcApiEndpoint.root` exposed):** is reverting acceptable,
   ...
   for jahow's review? Decision drives whether 024 is a fix or just a doc note.
