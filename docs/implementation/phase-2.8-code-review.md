...
it('returns correct URL with issueTime filter', () => {
  ...
  expect(url).toBe('...controlStreams/cs-001/commands?issueTime=2024-01-01T00%3A00%3A00.000Z%2F..');
});
...
it('returns correct URL with executionTime filter', () => {
  ...
  expect(url).toBe('...controlStreams/cs-001/commands?executionTime=2024-06-01T00%3A00%3A00.000Z%2F2024-12-01T00%3A00%3A00.000Z');
});
```
