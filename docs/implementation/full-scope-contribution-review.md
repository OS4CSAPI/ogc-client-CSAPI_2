...
| Deployments | `getDeployments`, `getDeployment`, `createDeployment`, `updateDeployment`, `deleteDeployment`, `getDeploymentSubdeployments`, `createSubdeployment`, `getDeploymentSystems` *(deprecated)*, `getDeploymentHistory` | 9 |
