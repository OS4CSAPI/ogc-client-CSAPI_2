...
|---------------|-----------------------|-----------|----------|
| *(none)* | `application/sml+json` | **Yes** (3 sys, 1 dep, 1 proc) | `{ items: [...] }` |
...
| OSH | /systems | Feature | *(empty)* | N/A — OSH returns GeoJSON even for SML Accept |
...
| *(null/empty)* | 52N | Systems (GeoJSON) | N/A | ❌ | Unrecognized (F41) |
