...
```json
{
  ...
  "identifiers": [{"label":"SerialNo","value":"526"}, {"label":"ProdNo","value":"5400"}],
  "typeOf": {"rel":"ogc-rel:procedures", "href":"https://csa.demo.52north.org/procedures/...", "urn":"urn:sensortype:aanderaa:dcps:td304"}
}
```
...
```json
{
  ...
  "contacts": [{"role":"...Operator", "organisationName":"BfN", "contactInfo":{"website":"..."}}],
  "location": {"type":"Point","coordinates":[12.0802287,54.1269457]},
  "platform": {"system":{"href":"urn:platform:5300-909"}},
  "deployedSystems": [
    {"name":"EXO3_Sonde", "system":{"href":"https://csa.demo.52north.org/systems/YSI599503-00-1"}},
    {"name":"DCPS_Sensor", "system":{"href":"https://csa.demo.52north.org/systems/5400-526"}}
  ]
}
```
...
```json
{
  "resultSchema": {
    ...
    "fields": [
      { "type": "Quantity", "name": "Temperature", "label": "Temperature",
...
```json
{
  "parametersSchema": {
    ...
    "name": "mavControl",
    "fields": [
      { "type": "Vector", "name": "locationVectorLLA",
        "coordinates": [
