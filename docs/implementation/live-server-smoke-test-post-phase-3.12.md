...
```json
{
  ...
  "referenceFrame": "",
  "coordinates": [
    { "type": "Quantity", "name": "ax", "axisID": "X", "uom": {"code":"m/s2"} },
    { "type": "Quantity", "name": "ay", "axisID": "Y", "uom": {"code":"m/s2"} },
    { "type": "Quantity", "name": "az", "axisID": "Z", "uom": {"code":"m/s2"} }
  ]
}
```
...
```json
{
  ...
  "coordinates": [
    { "type": "Quantity", "name": "vx", "axisID": "X", "uom": {"code":"m/s"} },
    { "type": "Quantity", "name": "vy", "axisID": "Y", "uom": {"code":"m/s"} },
    { "type": "Quantity", "name": "vz", "axisID": "Z", "uom": {"code":"m/s"} }
  ]
}
```
...
```json
{
  "items": [{
    ...
    "result": { "StatusType": "INFO", "Status": "EKF3 IMU1 MAG0 in-flight yaw alignment complete" }
  }]
}
```
...
```json
{
  "items": [{
    ...
    "result": { "Location": { "lat": 24.1807186, "lon": 120.6492485, "alt": 101.72 } }
  }]
}
```
