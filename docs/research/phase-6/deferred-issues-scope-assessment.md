...
| **Risk if included** | Low risk, but the issue's own deferral rationale states: *"F45 doesn't move the needle"* for acceptance likelihood. F46 (type narrowing) and F47 (missing combined test) were assessed as higher-value for reviewers. |
