...
4. ⚠️ **Type testing tools (tsd)** - Only if complex generics need validation
5. ⚠️ **Declarative HTTP mocking (nock)** - Only if manual mocking becomes cumbersome

**Priority 3 (Not urgent):**
6. ⚠️ **MSW (Mock Service Worker)** - Overkill for client library testing
