...
- High Issues: 4 (~~inflated counts~~ H1 resolved; ~~anti-pattern violations~~ H2 resolved + cleanup commit `fcdd3e3`; ~~directory mismatch~~ H3 resolved; naming inconsistency)
